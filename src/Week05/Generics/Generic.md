...
class Main {
    ...
    static <T extends Collection<Integer>> void Test(T n1) {
    ...
    public static void main(String[] args) {
        Test(new int[]{});
        Test(new Integer[]{{}});
        //Test(new boolean[]{});  --> COMPILATION ERROR
...
class Sms<T> {
    ...
    public static void staticSendSms() {
        System.out.println("Sending to " + PhoneAddressee + ", msg: " + Msg);
    }
}
